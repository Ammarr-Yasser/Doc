...
Figure~\ref{fig:auth-tool-sequence} illustrates the authentication and protected tool execution sequence used before tool processing.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.95\linewidth]{figures/fig-auth-and-tool-execution-sequence}
  \caption{Authentication and protected tool execution sequence}
  \label{fig:auth-tool-sequence}
\end{figure}
