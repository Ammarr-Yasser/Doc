...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig-link-analyzer-decision-flow}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/fig-link-analyzer-endpoints}
  \caption{Link Analyzer API endpoints}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/fig-link-analyzer-processing-pipeline}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{figures/fig-link-analyzer-redirect-reputation}
