...
Figure~\ref{fig:trust-boundaries} summarizes the security domains and trust boundaries used in this thesis scope.

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{figures/fig-trust-boundaries}
