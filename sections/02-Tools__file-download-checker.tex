...
\begin{figure}[H]
  ...
  \texttt{File Upload} $\rightarrow$ \texttt{Metadata/Hash} $\rightarrow$ \texttt{Reputation Lookup} $\rightarrow$ \texttt{Risk Output}
  }}
...
\begin{lstlisting}
File Upload -> Metadata/Hash -> Reputation Lookup -> Risk Output
\end{lstlisting}
