...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth,height=0.8\textheight,keepaspectratio]{figures/fig-file-checker-processing-flow}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/fig-file-checker-endpoint}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth,height=0.8\textheight,keepaspectratio]{figures/fig-file-checker-static-analysis-pipeline}
