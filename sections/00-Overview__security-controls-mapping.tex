...
This is a control-to-implementation map based on the current repository. Items not evidenced in code are marked as not evidenced in the reviewed codebase.
...
\item
  Status: Partially implemented; rotation and vault integration are not evidenced in the reviewed codebase.
\end{itemize}
...
\item
  Evidence: Not found.
\item
  Status: Not evidenced in the reviewed codebase.
\end{itemize}
