...
\begin{titlepage}
  ...
  \vspace{0.2cm}
  {\large Ahmed Bakr\par}
  {\large Ahmed Ammar\par}
  {\large Yasser Mohamed Ragab\par}
  {\large Mohamed Sama\par}
  {\large Mohamed Shahd\par}
  {\large Wael Shorouq\par}
  {\large Mohammed Farouq\par}
  \vspace{0.6cm}
  {\large \textbf{Supervised by:} Dr. Ahmed Abdelhaleem\par}
  {\large \textbf{Academic Year:} 2025--2026\par}
  {\large \textbf{Submission Date:} \rule{4cm}{0.4pt}\ 2026\par}
...
\input{sections/00-Overview__project-overview.tex}
\FloatBarrier

\chapter{System Architecture}
\input{sections/00-Overview__architecture-summary.tex}
\FloatBarrier
\input{sections/00-Overview__architecture-diagrams.tex}
\FloatBarrier
\input{sections/04-Frontend__frontend-architecture.tex}
\FloatBarrier
\input{sections/01-Backend__backend-overview.tex}
\FloatBarrier

\chapter{Security Model and Threat Analysis}
\input{sections/00-Overview__threat-model.tex}
\FloatBarrier
\input{sections/00-Overview__security-controls-mapping.tex}
\FloatBarrier
\input{sections/01-Backend__authentication-authorization.tex}
\FloatBarrier
\input{sections/01-Backend__security-hardening.tex}
\FloatBarrier
\input{sections/04-Frontend__frontend-security-model.tex}
\FloatBarrier

\chapter{Link Analyzer}
\input{sections/02-Tools__link-analyzer.tex}
\FloatBarrier

\chapter{File Download Checker}
\input{sections/02-Tools__file-download-checker.tex}
\FloatBarrier
...
\input{sections/00-Overview__future-work.tex}
\FloatBarrier
\input{sections/00-Overview__known-limitations.tex}
\FloatBarrier
